...
class Admin::MessagesController < Admin::BaseController
  ...
  def create
    ...
    if @message.errors.none?
      ...
      redirect_to admin_message_path(@message.record), notice: create_notice
    else
  ...
  def update
    ...
    if @message.errors.none?
      redirect_to admin_message_path(@record)
    else
  ...
  def destroy
    @record.trash
    redirect_to admin_messages_path, notice: "Message moved to trash."
  end
